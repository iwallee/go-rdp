...
func TestRun(t *testing.T) {
	...
	/*socket_param.On_connect = &server
	socket_param.On_before_accept = &server
	socket_param.On_accept = &server
	socket_param.On_disconnect = &server
	socket_param.On_recv = &server
	socket_param.On_send = &server
	socket_param.On_udp_recv = &server*/
